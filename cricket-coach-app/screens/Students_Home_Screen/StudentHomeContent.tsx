...
const StudentHomeContent = () => {
  ...
  const [coachRequests, setCoachRequests] = useState<Coach[]>(dummyCoachRequests);
 ...
 const handleTotalCoaches = () => {
  router.push({
    pathname: "/student-home/CoachesScreen", // Corrected spelling
    params: { 
      id: "1", // You need to pass actual coach ID
      name: "Coach Name", // Actual coach name
      photoUrl: "https://picsum.photos/300/300" // Actual photo URL
    },
  });
};
  ...
  const handleAcceptRequest = async (id: string) => {
    try {
      ...
      if (request) {
        ...
        const updatedCoach = { ...request, isMyCoach: true, joinDate: new Date().toISOString().split('T')[0] };
    ...
    >
        ...
        <View style={styles.sectionHeader}>
          ...
          {coachRequests.length > 0 && (
            <View style={styles.requestsBadge}>
              <Text style={styles.requestsBadgeText}>{coachRequests.length}</Text>
            </View>
          )}
        </View>
      ...
      <View style={styles.eventsContainer}>
        ...
        {events.slice(0, 3).map(event => (
          <TouchableOpacity key={event.id} style={styles.eventCard} onPress={handleCalendar}>
          ...
          <View style={styles.modalContent}>
            ...
            {selectedRequest && (
              <>
                ...
                />
                <Text style={styles.modalRole}>{selectedRequest.specialization}</Text>
                ...
                <View style={styles.performanceContainer}>
                  ...
                  <View style={styles.performanceMetrics}>
                    <View style={styles.metricItem}>
                      ...
                      <Text style={styles.metricValue}>{selectedRequest.rating}/5</Text>
                    </View>
                    <View style={styles.metricItem}>
                      <Text style={styles.metricLabel}>Experience</Text>
                      <Text style={styles.metricValue}>{selectedRequest.experience}</Text>
                    </View>
                  </View>
                </View>
